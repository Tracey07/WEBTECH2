...
<h3 class="title"><i class='fas fa-cog'></i> Property</h3>
<ul class="description navbar-nav">

     
      <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=website-setting&subcat=website-setting">Property Details</a>
...
<!--==== accordion list-3 =====-->
<li class="nav-item accordion-content hide">
<h3 class="title"><i class='fas fa-envelope'></i> Agent</h3>
<ul class="description navbar-nav">

     <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=contact&subcat=contact-details">Agent Details</a>
    </li>
...
<a href="../index.php" id="hide"><i class='far fa-arrow-alt-circle-left'></i></a>
</li>
